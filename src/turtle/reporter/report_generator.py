...
from src.turtle.llm.cross_validation_agent import CrossValidationResult
from src.turtle.llm.analysis_agent import RootCauseAnalysisResult
...
<title>Augur 分析报告 — {{ name }} ({{ ts_code }})</title>
<style>
...
<div class="header">
  ...
  <div style="margin-top:8px;color:var(--text-dim);font-size:0.85rem;">Augur v0.36 · {{ generated_at }}</div>
</div>
...
<div class="footer">
  Augur v0.36 · 本报告仅供研究参考，不构成投资建议。<br>
  生成时间: {{ generated_at }}
</div>
</body></html>"""
